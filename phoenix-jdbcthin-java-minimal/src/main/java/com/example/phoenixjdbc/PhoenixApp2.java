/**
* Sample program to demonstrate Phoenix JDBC connectivity via Phoenix Query server
*
...
public class PhoenixApp2
{
	public static void main(String[] args) throws SQLException 
	{
		...
		try 
		{
			InputStream is = PhoenixApp2.class.getResourceAsStream("/connection.properties");
		...
		{
			System.out.println("Exception Loading Driver - org.apache.phoenix.queryserver.client.Driver");
			e.printStackTrace();
		}
		try
		{
